export default function LandingPage() {
  return (
    <div className="font-[var(--font-inter)]" style={{ color: '#1a1a2e' }}>

      {/* ── 1. NAVBAR ─────────────────────────────────────────────────── */}
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          {/* Logo */}
          <a href="#" className="font-[var(--font-playfair)] text-xl font-bold tracking-tight" style={{ color: '#1a1a2e' }}>
            Concierg&apos;ori
          </a>

          {/* Nav links */}
          <nav className="hidden md:flex items-center gap-8">
            <a href="#services" className="text-sm font-medium text-gray-600 hover:text-[#D4A853] transition-colors">Services</a>
            <a href="#tarifs" className="text-sm font-medium text-gray-600 hover:text-[#D4A853] transition-colors">Tarifs</a>
            <a href="#contact" className="text-sm font-medium text-gray-600 hover:text-[#D4A853] transition-colors">Contact</a>
          </nav>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full opacity-10 pointer-events-none" style={{ background: 'radial-gradient(circle, #D4A853 0%, transparent 70%)', transform: 'translate(30%, -30%)' }} />

        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32 flex flex-col items-center text-center">
          {/* Trust badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-200 text-sm font-medium mb-8" style={{ color: '#D4A853' }}>
            <span className="w-2 h-2 rounded-full bg-[#D4A853] animate-pulse" />
            15+ biens gérés à Caen
          </div>

          {/* Headline */}
          <h1 className="font-[var(--font-playfair)] text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 max-w-4xl" style={{ color: '#1a1a2e' }}>
            Votre conciergerie<br />
            <span style={{ color: '#D4A853' }}>Airbnb à Caen</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            ...
            <a
              href="#services"
              className="inline-flex items-center justify-center px-8 py-4 rounded-full text-base font-semibold border-2 transition-all hover:bg-amber-50"
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 text-center">
            {[
              ...
              <div key={stat.label}>
                <div className="font-[var(--font-playfair)] text-3xl font-bold" style={{ color: '#D4A853' }}>{stat.value}</div>
      ...
      <section id="services" className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#D4A853' }}>Ce que nous faisons</p>
            <h2 className="font-[var(--font-playfair)] text-3xl md:text-4xl font-bold" style={{ color: '#1a1a2e' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={service.title}
                className="bg-white rounded-2xl p-7 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all group"
              >
                <div className="text-4xl mb-5">{service.emoji}</div>
                <h3 className="font-[var(--font-playfair)] text-lg font-semibold mb-2 group-hover:text-[#D4A853] transition-colors" style={{ color: '#1a1a2e' }}>
                  {service.title}
                </h3>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#D4A853' }}>Simple comme bonjour</p>
            <h2 className="font-[var(--font-playfair)] text-3xl md:text-4xl font-bold" style={{ color: '#1a1a2e' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative">
            ...
            <div className="hidden md:block absolute top-12 left-[calc(16.666%+2rem)] right-[calc(16.666%+2rem)] h-0.5 bg-gradient-to-r from-transparent via-amber-200 to-transparent" />
            ...
            {[
              ...
              <div key={item.step} className="flex flex-col items-center text-center">
                <div
                  className="w-24 h-24 rounded-full flex items-center justify-center text-white font-[var(--font-playfair)] text-2xl font-bold mb-6 shadow-lg"
                  style={{ backgroundColor: '#D4A853' }}
                >
                  {item.step}
                </div>
                <h3 className="font-[var(--font-playfair)] text-xl font-bold mb-3" style={{ color: '#1a1a2e' }}>{item.title}</h3>
      ...
      <section className="py-20 md:py-28" style={{ backgroundColor: '#1a1a2e' }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#D4A853' }}>La différence</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={benefit.title} className="rounded-2xl p-8 border border-white/10 bg-white/5 hover:bg-white/10 transition-all">
                ...
                <div className="inline-block px-3 py-1 rounded-full text-xs font-semibold mb-4" style={{ backgroundColor: '#D4A853', color: '#1a1a2e' }}>
                  {benefit.highlight}
                </div>
                <h3 className="font-[var(--font-playfair)] text-lg font-bold text-white mb-3">{benefit.title}</h3>
      ...
      <section className="py-20 md:py-28 bg-amber-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#D4A853' }}>Ils nous font confiance</p>
            <h2 className="font-[var(--font-playfair)] text-3xl md:text-4xl font-bold" style={{ color: '#1a1a2e' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={testimonial.name} className="bg-white rounded-2xl p-7 shadow-sm border border-amber-100">
                {/* Stars */}
                <div className="flex gap-1 mb-5">
                  {Array.from({ length: testimonial.rating }).map((_, i) => (
                    <span key={i} className="text-lg" style={{ color: '#D4A853' }}>★</span>
                  ))}
                </div>
                {/* Quote */}
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold" style={{ backgroundColor: '#D4A853' }}>
                    {testimonial.name[0]}
                  </div>
                  <div>
                    <div className="font-semibold text-sm" style={{ color: '#1a1a2e' }}>{testimonial.name}</div>
      ...
      <section id="contact" className="py-20 md:py-28 bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="rounded-3xl p-12 md:p-16" style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #2d2d4e 100%)' }}>
            <p className="text-sm font-semibold uppercase tracking-widest mb-4" style={{ color: '#D4A853' }}>Réservation directe</p>
            <h2 className="font-[var(--font-playfair)] text-3xl md:text-4xl font-bold text-white mb-5">
              Prêt à réserver ?
            </h2>
      ...
      {/* ── 8. FOOTER ─────────────────────────────────────────────────── */}
      <footer id="tarifs" className="border-t border-gray-100 bg-white">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <nav className="flex flex-wrap justify-center gap-6">
              <a href="#services" className="text-sm text-gray-500 hover:text-[#D4A853] transition-colors">Services</a>
              <a href="#tarifs" className="text-sm text-gray-500 hover:text-[#D4A853] transition-colors">Tarifs</a>
              <a href="#contact" className="text-sm text-gray-500 hover:text-[#D4A853] transition-colors">Contact</a>
              <a href="#" className="text-sm text-gray-500 hover:text-[#D4A853] transition-colors">Mentions légales</a>
            </nav>
